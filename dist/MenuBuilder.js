...
var MenuBuilder = /** @class */ (function () {
    ...
    MenuBuilder.prototype.buildMenu = function () {
        var template = process.platform === 'darwin' ? this.buildDarwinTemplate() : this.buildDefaultTemplate();
    ...
    MenuBuilder.prototype.buildDarwinTemplate = function () {
        ...
        var subMenuView = process.env.NODE_ENV === 'development' || process.env.DEBUG_PROD === 'true'
            ? subMenuViewDev
            : subMenuViewProd;
